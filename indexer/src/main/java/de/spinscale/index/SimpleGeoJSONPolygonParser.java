/* copied from the lucene implementation to fix minor bugs */
...
class SimpleGeoJSONPolygonParser {
    ...
    public Double getGeomLatitude() {
        return latitude;
    }

    public Double getGeomLongitude() {
        return longitude;
    }
    ...
    private void parseObject(String path) throws ParseException {
        ...
        while (true) {
            ...
            // special handling for our coordinates
            // prefer wd: coordinates over lbl: coordinates
            if (path.equals("properties") && key.equals("wd:latitude")) {
                this.latitude = (double) o;
            } else if (path.equals("properties") && key.equals("wd:longitude")) {
                this.longitude = (double) o;
            } else if (path.equals("properties") && key.equals("lbl:latitude") && this.latitude == null) {
                this.latitude = (double) o;
            } else if (path.equals("properties") && key.equals("lbl:longitude") && this.longitude == null) {
                this.longitude = (double) o;
            }
